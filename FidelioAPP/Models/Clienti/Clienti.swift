...
struct pageClienti: Decodable {
    var current_page : Int?
    var risClienti: Clienti?
...
extension pageClienti {
    ...
    init(from decoder: Decoder) throws {
        ...
        risClienti = try keyedContainer.decodeIfPresent(Clienti.self, forKey: .data)
    }
...
//MATTEO: struttura per i clienti (array di cliente)
